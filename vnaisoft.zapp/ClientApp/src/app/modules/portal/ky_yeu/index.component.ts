...
@Component({
    selector: 'portal_ky_yeu_index',
    templateUrl: './index.component.html',
    styleUrls: ['./index.component.scss'],
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class portal_ky_yeu_indexComponent implements OnInit, OnDestroy {
    ...
    load_panel() {
        ...
        // ];
        this.http
            .post('/sys_ky_yeu.ctr/get_ky_yeu/', {}
            ).subscribe(resp => {
    ...
    ngOnInit(): void {
        ...
        var title = 'Quản Lý Kho Hàng - ' + this._translocoService.translate('portal.aboutus');
        var metaTag = [
