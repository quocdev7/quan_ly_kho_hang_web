...
@Component({
    selector: 'manager_folder_indexGrid',
    templateUrl: './indexGrid.component.html',
    styleUrls: ['./indexGrid.component.scss']
})

export class manager_folder_indexGridComponent extends BaseIndexDatatableComponent {
    @Input() lst_data: any;
    ...
    copy(id): void {
        ...
        // document.getElementById("myToast").classList.remove("hidden_toat");
        // document.getElementById("myToast").classList.add("block_toat");
        // // Hide the toast after 5 seconds (5000ms)
        // // you can set a shorter/longer time by replacing "5000" with another number
        // setTimeout(function () {
        //     document.getElementById("myToast").classList.remove("block_toat");
        //     document.getElementById("myToast").classList.add("hidden_toat");
        // }, 2000);
    }
    user_login: any
    list_role_share: any
