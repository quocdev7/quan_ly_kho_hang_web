...
@Component({
    selector: 'popupBackground',
    templateUrl: 'popupBackground.component.html',
})
export class popupBackgroundEditComponent extends BasePopUpAddComponent {
    public wallpaperImage = [
        "assets/images/whatsApp/chatbackground.jpg",
        "assets/images/whatsApp/Whatsapp-Wallpaper-1.jpg",
        "assets/images/whatsApp/Whatsapp-Wallpaper-2.jpg",
        "assets/images/whatsApp/Whatsapp-Wallpaper-3.jpg",
        "assets/images/whatsApp/Whatsapp-Wallpaper-4.jpg",
        "assets/images/whatsApp/Whatsapp-Wallpaper-5.jpg",
        "assets/images/whatsApp/Whatsapp-Wallpaper-6.jpg",
    ];
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<popupBackgroundEditComponent>,
    ...
    update_avatar() {
        ...
        var image = this.record.db.avatar_path
