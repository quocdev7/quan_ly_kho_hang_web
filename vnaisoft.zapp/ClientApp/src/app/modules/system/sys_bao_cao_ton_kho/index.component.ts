...
// import { erp_loai_mat_hang_popUpAddComponent } from 'app/modules/erp/erp_loai_mat_hang/popupAdd.component';
...
//         this.http.post('/erp_loai_mat_hang.ctr/getElementByMa', {
//             ma: ma_loai_mat_hang
//         }).subscribe(resp => {
...
//         model.actionEnum = 3;
//         const dialogRef = this.dialog.open(erp_loai_mat_hang_popUpAddComponent, {
//             disableClose: true,
//             autoFocus: false,
//             width: '768px',
//             data: model
...
//     ngOnInit(): void {
//         this.baseInitData();
//         var title = 'SHUNGO-' + this._translocoService.translate('NAV.bao_cao_ton_kho_mat_hang');
//         var metaTag = [
