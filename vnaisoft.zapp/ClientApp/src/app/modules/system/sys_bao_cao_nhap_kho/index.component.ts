...
// import { erp_phieu_nhap_kho_popUpAddComponent } from 'app/modules/erp/erp_phieu_nhap_kho/popupAdd.component';
// import { erp_khach_hang_nha_cung_cap_popUpAddComponent } from 'app/modules/erp/erp_khach_hang_nha_cung_cap/popupAdd.component';
// import { kt_chung_tu_nhap_popUpAddComponent } from 'app/modules/ke_toan/kt_chung_tu_nhap/popupAdd.component';

// @Component({
//     selector: 'bao_cao_nhap_kho_index',
//     templateUrl: './index.component.html',
//     styleUrls: ['./index.component.scss']
// })

// export class bao_cao_nhap_kho_indexComponent extends BaseIndexDatatableComponent {
...
//     public data_phieu_nhap_kho: any;
//     constructor(
...
//     ) {
//         super(http, baseUrl, _translocoService, _fuseNavigationService, route, dialog, 'bao_cao_nhap_kho',
...
//     public get_phieu_nhap_kho(ma_phieu_nhap_kho) {
//         this.showLoading("", "", true);
//         this.http.post('/kt_chung_tu_nhap.ctr/getElementByMa', {
//             ma: ma_phieu_nhap_kho
//         }).subscribe(resp => {
//             this.data_phieu_nhap_kho = resp;
//             this.openDialogDetailPhieuNhapKho(this.data_phieu_nhap_kho);
//             Swal.close();
//         })
//     }
//     public openDialogDetailPhieuNhapKho(model) {
//         model.actionEnum = 3;
//         const dialogRef = this.dialog.open(kt_chung_tu_nhap_popUpAddComponent, {
//             disableClose: true,
//             autoFocus: false,
//             width: '768px',
//             data: model
...
//             ;
//         var uri = '/bao_cao_nhap_kho.ctr/exportExcel';
...
//                 a.target = '_dAblank';
//                 a.download = 'bao_cao_nhap_kho.xlsx'
//                 a.click();
...
//     ngOnInit(): void {
//         this.baseInitData();
//         var title = 'SHUNGO-' + this._translocoService.translate('NAV.bao_cao_nhap_kho');
//         var metaTag = [
