...
export class sys_loai_nhap_xuat_indexComponent extends BaseIndexDatatableComponent {
    ...
    dowloadFileMau() {
        var url = '/sys_loai_nhap_xuat.ctr/downloadtemp';
    ...
    exportToExcel() {
        ...
        const params = new HttpParams()
            ...
            .set('type', this.filter.loai)
            ;
        var uri = '/sys_loai_nhap_xuat.ctr/exportExcel';
    ...
    onSubmitFile(event: any) {
        if (this.file == null || this.file == undefined) {
            ...
            this.http.post('/sys_loai_nhap_xuat.ctr/ImportFromExcel/', formData, {
            })
                .subscribe(resp => {
                        Swal.close();
                        var res
