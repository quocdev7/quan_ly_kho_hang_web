...
export class MessagesComponent extends BaseIndexDatatableComponent implements OnInit, OnChanges, OnDestroy
{
    ...
    constructor(http: HttpClient, dialog: MatDialog
        ...
        , _fuseNavigationService: FuseNavigationService, route: ActivatedRoute, private _changeDetectorRef: ChangeDetectorRef,
        private _messagesService: MessagesService,
        private _overlay: Overlay,
        private _viewContainerRef: ViewContainerRef
        , @Inject('BASE_URL') baseUrl: string
        ) {
        super(http, baseUrl, _translocoService, _fuseNavigationService, route, dialog, 'sys_notification',
            { }
        )
        this.http
        .post(this.controller + '.ctr/getListUse/',
            {
            }
        ).subscribe(resp => {
            this.messagess=resp
