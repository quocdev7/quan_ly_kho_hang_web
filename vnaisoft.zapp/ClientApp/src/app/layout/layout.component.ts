...
export class LayoutComponent implements OnInit, OnDestroy
{
    ...
    private _updateLayout(): void
    {
        ...
        var vnaisoft_empty_layout=localStorage.getItem('vnaisoft_empty_layout');
        if(vnaisoft_empty_layout!=null && vnaisoft_empty_layout !="" && vnaisoft_empty_layout!=undefined){
