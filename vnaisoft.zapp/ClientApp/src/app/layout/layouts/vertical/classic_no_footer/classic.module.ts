...
import { SearchAdminModule } from 'app/layout/common/search_admin/search_admin.module';
import { ClassicLayoutNoFooterComponent } from './classic.component';

@NgModule({
    declarations: [
        ClassicLayoutNoFooterComponent
    ],
    imports: [
        HttpClientModule,
        RouterModule,
...
export class ClassicLayoutNoFooterModule {
}
