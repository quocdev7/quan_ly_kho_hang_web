...
@Component({
    selector: 'cm_view_file_uploadMul',
    templateUrl: 'cm_view_file_uploadMul.component.html'
})
export class cm_view_file_uploadMulComponent extends BaseIndexDatatableComponent {
    ...
    public show_details: any = false;
      public icon_classes: any = false;
    constructor(public dialogRef: MatDialogRef<cm_view_file_uploadMulComponent>, dialog: MatDialog,
...
debugger
     this.file = data;
      this.icon_classes = {
        ...
        var url = data.url.replace("/downloadFileMul?ids=", "/viewonlineMul?ids=");
