...
export class FuseVerticalNavigationComponent implements OnChanges, OnInit, AfterViewInit, OnDestroy {
    ...
    toggleAside(item: FuseNavigationItem): void {
        // Toggle
        //const storedState = localStorage.getItem('asideState');
        //if (storedState) {
        //    this.isAsideOpen = storedState === 'open';
        //}
        //this.isAsideOpen = !this.isAsideOpen;
        //localStorage.setItem('asideState', this.isAsideOpen ? 'open' : 'closed');
    ...
    private _showAsideOverlay(): void {
        ...
        // Otherwise
            ...
            this._fuseScrollbarDirectives.forEach((fuseScrollbarDirective) => {
                ...
                // Scroll to the active element
                fuseScrollbarDirective.scrollToElement('.fuse-vertical-navigation-item-active', -300, true);
            });
        }
