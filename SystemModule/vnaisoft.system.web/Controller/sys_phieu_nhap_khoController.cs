...
//{
//    public partial class erp_phieu_nhap_khoController : BaseAuthenticationController
//    {
//        public erp_phieu_nhap_kho_repo repo;
//        public AppSettings _appsetting;

//        public erp_phieu_nhap_khoController(IUserService userService, MongoDBContext context, IOptions<AppSettings> appsetting) : base(userService)
//        {
//            repo = new erp_phieu_nhap_kho_repo(context);
//            _appsetting = appsetting.Value;
//        }

//        public IActionResult getListUse()
//        {
//            var result = repo._context.erp_phieu_nhap_khos.AsQueryable()
...
//            var template = repo._context.erp_mau_ins.AsQueryable().Where(t => t.id_loai == "erp_phieu_nhap_kho").FirstOrDefault();
...
//            var queryTableDetail = repo._context.erp_phieu_nhap_kho_chi_tiets.AsQueryable();
...
//            var list_mat_hang_group = list_mat_hang.GroupBy(q => q.id_mat_hang).Select(q => new erp_phieu_nhap_kho_chi_tiet_ref_model
//            {
//                id_mat_hang = q.Key,
...
//            var don_hang = repo._context.erp_don_hang_bans.AsQueryable().Where(d => d.id == id_don_hang).Where(d => d.status_del == 1).SingleOrDefault();
//            var van_chuyen = new erp_phieu_nhap_kho_chi_tiet_ref_model();
...
//            var list_mat_hang = new List<erp_phieu_nhap_kho_model>();
//            var list_mat_hang_ignore = new List<erp_phieu_nhap_kho_model>();
//            try
//            {
//                list_mat_hang_ignore = JsonConvert.DeserializeObject<List<erp_phieu_nhap_kho_model>>(json.GetValue("list_mat_hang").ToString());
//            }
//            catch
//            {

//            }
//            var queryTable = repo._context.erp_phieu_nhap_khos.AsQueryable().Where(q => q.status_del == 1);
...
//            string Files = newPath + "\\erp_phieu_nhap_kho.xlsx";
//            byte[] fileBytes = System.IO.File.ReadAllBytes(Files);
//            System.IO.File.WriteAllBytes(Files, fileBytes);
//            MemoryStream ms = new MemoryStream(fileBytes);
//            return File(fileBytes, System.Net.Mime.MediaTypeNames.Application.Octet, "erp_phieu_nhap_kho.xlsx");
//        }
...
//            var queryTable = repo._context.erp_phieu_nhap_khos.AsQueryable().Where(d => d.status_del == status_del)
...
//            return await exportFileExcel(_appsetting, header, listKey, dataList, "erp_phieu_nhap_kho");
//        }
//        [HttpPost]
//        public async Task<IActionResult> create([FromBody] JObject json)
//        {
//            var model = JsonConvert.DeserializeObject<erp_phieu_nhap_kho_model>(json.GetValue("data").ToString());
...
//            var queryTable = repo._context.erp_phieu_nhap_khos.AsQueryable();
...
//                });
//                DTResult<erp_phieu_nhap_kho_model> result = new DTResult<erp_phieu_nhap_kho_model>
//                {
//                    start = param.Start,
//                    draw = param.Draw,
//                    data = dataList,
...
//                var queryTable = repo._context.erp_phieu_nhap_kho_logs.AsQueryable().Where(d => d.status_del == 1)
//                    .Where(d => d.ma == ma)
...
//                dataList.ForEach(d =>
//                {
//                    d.ten_loai_nhap = repo._context.erp_loai_nhap_xuats.AsQueryable().Where(q => q.ma == d.db.id_loai_nhap).Select(q => q.ten).SingleOrDefault();
//                });
//                DTResult<erp_phieu_nhap_kho_log_model> result = new DTResult<erp_phieu_nhap_kho_log_model>
//                {
//                    start = param.Start,
//                    draw = param.Draw,
//                    data = dataList,
...
//            string Files = newPath + "\\erp_mat_hang_theo_phieu_nhap.xlsx";
//            byte[] fileBytes = System.IO.File.ReadAllBytes(Files);
//            System.IO.File.WriteAllBytes(Files, fileBytes);
//            MemoryStream ms = new MemoryStream(fileBytes);
//            return File(fileBytes, System.Net.Mime.MediaTypeNames.Application.Octet, "erp_mat_hang_theo_phieu_nhap.xlsx");
//        }
//        [HttpPost]
...
//                try
//                {
//                    var list_model = new List<erp_phieu_nhap_kho_model>();
...
//                        var model = new erp_phieu_nhap_kho_model();
...
//                        model.list_mat_hang = list_model.Where(q => q.db.ma == ma).Select(d => new erp_phieu_nhap_kho_chi_tiet_model
//                        {
...
//                            {
//                                var doi_tuong = repo._context.erp_khach_hang_nha_cung_caps.AsQueryable().Where(d => d.ma.Trim().ToLower() == model.db.id_doi_tuong.Trim().ToLower()).SingleOrDefault();
...
//                    db_log.error = error;
//                    db_log.controller = "erp_phieu_nhap_kho";
...
//            var error = "";
//            IFormFile file = Request.Form.Files[0];
//            var model_master = JsonConvert.DeserializeObject<erp_phieu_nhap_kho_model>(Request.Form["model"]);
//            var rs = "";
...
//                        var model = new erp_phieu_nhap_kho_chi_tiet_model();
