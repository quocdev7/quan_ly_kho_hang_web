...
//{
//    partial class erp_phieu_nhap_khoController
//    {
...
//            url = "/erp_phieu_nhap_kho_index",
//            title = "erp_phieu_nhap_kho",
//            translate = "NAV.erp_phieu_nhap_kho",
//            type = "item",
//            //is_show_all_user = true,
//            list_controller_action_public = new List<string>(){
//                  "erp_phieu_nhap_kho;create",
//                   "erp_phieu_nhap_kho;edit",
//                    "erp_phieu_nhap_kho;delete",
//                     "erp_phieu_nhap_kho;get_code",
//                      "erp_phieu_nhap_kho;ImportFromExcel",
//                       "erp_phieu_nhap_kho;exportExcel",
//                       "erp_phieu_nhap_kho;getElementById",
//                         "erp_phieu_nhap_kho;get_list_mat_hang_ban",
//                         "erp_phieu_nhap_kho;getListUse",
//                         "erp_print_phieu_nhap_kho;in_phieu_nhap_kho",
//                         "erp_phieu_nhap_kho;update_status_del",
//                         "erp_phieu_nhap_kho;ImportFromExcelMatHang",
//                         "erp_phieu_nhap_kho;getElementById",
//                         "erp_phieu_nhap_kho;getPrint",
//                         "erp_phieu_nhap_kho;get_list_mat_hang_cua_phieu_nhap",
//                         "erp_phieu_nhap_kho;getElementByMa",
//                         "erp_phieu_nhap_kho;getElementByIdLog",
//                         "erp_phieu_nhap_kho;DatahandlerHistoryEdit",
//            },

//            list_controller_action_publicNonLogin = new List<string>(){

//                    "erp_phieu_nhap_kho;downloadtemp",
//                    "erp_phieu_nhap_kho;downloadtempdetail",
//            },
...
//                  new ControllerRoleModel()
//                {
//                    id="erp_phieu_nhap_kho;list",
//                    name="list",
//                    list_controller_action = new List<string>()
//                    {
//                          "erp_phieu_nhap_kho;DataHandler",
//                    }
//                }
//            }
//        };

//        private bool checkModelStateCreate(erp_phieu_nhap_kho_model item)
//        {
//            return checkModelStateCreateEdit(ActionEnumForm.create, item);
//        }

//        private bool checkModelStateEdit(erp_phieu_nhap_kho_model item)
//        {
//            return checkModelStateCreateEdit(ActionEnumForm.edit, item);
//        }
//        private bool checkModelStateCreateEdit(ActionEnumForm action, erp_phieu_nhap_kho_model item)
//        {
...
//        }
//        public string CheckErrorImport(erp_phieu_nhap_kho_model model, int ct, string error)
//        {
...
//            else
//            {
//                var check = repo._context.erp_phieu_nhap_khos.AsQueryable().Where(q => q.ma.Trim().ToLower() == model.db.ma.Trim().ToLower()).SingleOrDefault();
//                if (check != null)
//                {
...
//            else
//            {
//                var check = repo._context.erp_loai_nhap_xuats.AsQueryable().Where(q => q.id.Trim().ToLower() == model.db.id_loai_nhap.Trim().ToLower()).SingleOrDefault();
//                if (check == null)
//                {
...
//                    }
//                }
//                var list_don_hang_chi_tiet = repo._context.erp_don_hang_mua_mat_hangs.AsQueryable().Where(d => d.id_don_hang == model.ma_don_hang).Where(d => d.status_del == 1).ToList();
...
//                    }
//                }
//                var list_don_hang_chi_tiet = repo._context.erp_don_hang_ban_mat_hangs.AsQueryable().Where(d => d.id_don_hang == model.ma_don_hang).Where(d => d.status_del == 1).ToList();
//                if (!string.IsNullOrEmpty(model.ma_don_hang))
//                {
//                    for (int i = 0; i < list_don_hang_chi_tiet.Count(); i++)
//                    {
...
//        public string CheckErrorImportDetail(erp_phieu_nhap_kho_chi_tiet_model model, int ct, string error)
//        {
...
//            else
//            {
//                var check = repo._context.erp_phieu_nhap_khos.AsQueryable().Where(q => q.id.Trim().ToLower() == model.db.id_phieu_nhap_kho.Trim().ToLower()).SingleOrDefault();
//                if (check == null)
//                {
//                    error += "Mã phiếu nhập kho tại dòng " + (ct + 1) + " không tồn tại <br />";
//                }
//                // kiểm tra so lượng mặt hàng
//                var phieu_nhap_kho = repo._context.erp_phieu_nhap_khos.AsQueryable().Where(d => d.id == model.db.id_phieu_nhap_kho).Where(d => d.status_del == 1).SingleOrDefault();
...
//                    .Sum(q => q.so_luong) ?? 0;
//                    var px = repo._context.erp_phieu_xuat_khos.AsQueryable().Where(q => q.id_don_hang_ban == phieu_nhap_kho.id_don_hang_ban).Select(q => q.id).ToList();
//                    var so_luong_mat_hang_px = repo._context.erp_phieu_xuat_kho_chi_tiets.AsQueryable()
//                       .Where(q => px.Contains(q.id_phieu_xuat_kho) && q.status_del == 1 && q.id_mat_hang == model.db.id_mat_hang).Sum(q => q.so_luong) ?? 0;

//                    var pn = repo._context.erp_phieu_nhap_khos.AsQueryable().Where(q => q.id_don_hang_ban == phieu_nhap_kho.id_don_hang_ban).Select(q => q.id).ToList();
//                    var so_luong_mat_hang_pn = repo._context.erp_phieu_nhap_kho_chi_tiets.AsQueryable()
...
//                   .Sum(q => q.so_luong) ?? 0;
//                    var px = repo._context.erp_phieu_xuat_khos.AsQueryable().Where(q => q.id_don_hang_mua == phieu_nhap_kho.id_don_hang_mua).Select(q => q.id).ToList();
//                    var so_luong_mat_hang_px = repo._context.erp_phieu_xuat_kho_chi_tiets.AsQueryable()
//                       .Where(q => px.Contains(q.id_phieu_xuat_kho) && q.status_del == 1 && q.id_mat_hang == model.db.id_mat_hang).Sum(q => q.so_luong) ?? 0;

//                    var pn = repo._context.erp_phieu_nhap_khos.AsQueryable().Where(q => q.id_don_hang_mua == phieu_nhap_kho.id_don_hang_mua).Select(q => q.id).ToList();
//                    var so_luong_mat_hang_pn = repo._context.erp_phieu_nhap_kho_chi_tiets.AsQueryable()
//                       .Where(q => pn.Contains(q.id_phieu_nhap_kho) && q.status_del == 1 && q.id_mat_hang == model.db.id_mat_hang).Sum(q => q.so_luong) ?? 0;
...
//            return error;
//        }
//        public string CheckErrorImportMatHang(erp_phieu_nhap_kho_chi_tiet_model model, int ct, string error)
//        {
